...
<body class="bg-white dark:bg-zinc-900"> <!-- Tailwind CSS class for light and dark mode background -->
    ...
    <div class="max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center my-10">
        <div class="p-5 flex flex-col items-center">
            ...
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $profile->name }}</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $profile->birthdate }} {{ $profile->birthplace }}</p>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $profile->address }}</p>
